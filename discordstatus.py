...
if __name__ == "__main__":
    ...
    while True:
        while lastRecordedTime == minute:
            ...
            minute = timeNow.minute
        lastRecordedTime = minute
        changeStatus(_COOKIE, "🕒 " + str(hour) + ":" + str(minute) + " 🕒", None)
